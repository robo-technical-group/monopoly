...
namespace Strings {
    ...
    export const MENU_BOARD_MOVE_BACKWARD: string = 'Move Back'
    export const MENU_BOARD_MOVE_FORWARD: string = 'Move Forward'
    export const MENU_BOARD_SELECT: string = 'Select'
